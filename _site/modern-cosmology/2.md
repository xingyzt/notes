...
This is done by substituting the three-momentum and energy with the four-momentum $P^\alpha = (E, \vec p)$
in a comoving reference frame (which flows locally with the particles). 
...
and $\d^3 P \equiv \d P\_1 \d P\_2 \d P\_3$ is the four-momentum's spatial volume element.
