...
Its net effect on the dynamics of species $1$ can be broken down into 
...
\\\
E\_1(\vec p\_1) + E\_2(\vec p\_2) &= E\_3(\vec p\_3') + E\_4(\vec p\_4'),
\tag{3.45}
\end{aligned}\\]
...
Putting it all together, the collision term for a species $1$ particle traveling with momentum $\vec p\_1$ is
\\[\begin{aligned}
C[f\_1(\vec p\_1)] &= 
...
\\\
&\quad\cdot \delta\_D^{(1)}(E\_3(\vec p\_3') + E\_4(\vec p\_4') - E\_1(\vec p\_1) - E\_2(\vec p\_2))
\\\
...
But this is non-relativistic and does not account for the peculiarities of spin statistics.
