...
they also obey the Heisenberg uncertainty principle. 
So, like physical position and momentum, we cannot distinguish four-dimensional phase-space coordinates less than
$\Delta E\Delta t < 2\pi$
in separation.
...
\tag{3.47}
\end{aligned}\\]
where the additional $2\pi$ factor in front of the Dirac delta accounts for the uncertainty in energy.
...
\\\
&\quad\cdot [2\pi]^4
\delta\_D^{(3)}(\vec p\_3' + \vec p\_4' - \vec p\_1 - \vec p\_2)
\\\
&\quad\cdot \delta\_D^{(1)}(E\_3(p\_3') + E\_4(p\_4') - E\_1(p\_1) - E\_2(p\_2))
\\\
&\quad \cdot |\mathcal M(\vec p\_1, \vec p\_2, \vec p\_3', \vec p\_4')|^2
